  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 right-20 w-80 h-80 bg-medical-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float"></div>
        <div className="absolute bottom-20 left-20 w-80 h-80 bg-accent-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float animation-delay-2000"></div>
      </div>
        ...
        {/* <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16 animate-fadeInUp animation-delay-1000">
          {services.map((service) => {
            ...
            return (
              <div
                key={service.id}
                className="group bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-2xl hover:shadow-medical-500/20 transition-all duration-500 border border-medical-100/50 transform hover:scale-105 hover:-translate-y-2"
              >
                <div className="w-20 h-20 bg-gradient-to-br from-medical-100 via-accent-100 to-medical-100 rounded-2xl flex items-center justify-center mb-6 transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
                  <IconComponent className="text-medical-600 group-hover:animate-bounce" size={32} />
                </div>
                <h3 className="text-2xl font-bold bg-gradient-to-r from-medical-600 to-accent-500 bg-clip-text text-transparent mb-4">{service.name}</h3>
                <p className="text-gray-700 leading-relaxed mb-6">{service.description}</p>
                <button className="group/btn text-medical-600 font-medium hover:text-medical-700 transition-all duration-300 flex items-center space-x-2 transform hover:translate-x-2">
